#!/bin/bash
CURRENTPATH='/home/rfinster/Masterarbeit/Code/code_aktueller_Stand_neu/'
...
sed "s/#disorder/$param2/g" < parameters > open_chain_random_mu${param}.cfg
...
qsub -mem 4 -args open_chain_random_mu${param}.cfg heisenberg_liouville_space  
cd $CURRENTPATH
